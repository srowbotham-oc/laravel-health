...
When `RunHealthChecksCommand` executes, the selected checks will be run. The results of these checks can be stored. Out of the box, this package offers two stores:
