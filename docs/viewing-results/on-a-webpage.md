...
The package contains a controller `Spatie\Health\Http\Controllers\HealthCheckResultsController` that can be used to render the latest stored check results. Simply use that controller in your routes on any URL you desire.
